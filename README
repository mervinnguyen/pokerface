...
```
├── src/
│   ├── server/          # Server entry point, connection handler, game engine
│   ├── client/          # Client entry point, GUI layer, socket I/O
│   ├── game/            # Hand evaluation, deck, state machine logic
│   └── common/          # Shared structs, protocol definitions, utilities
